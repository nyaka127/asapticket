...
export async function GET(request: Request) {
  ...
  if (!hasAmadeusKeys) {
    const airlinesList = [
      { name: 'Emirates', code: 'EK', base: 850, alliance: 'Private/Partner', logo: '/assets/united_flight.png' },
      { name: 'United Airlines', code: 'UA', base: 830, alliance: 'Star Alliance', logo: '/assets/united_flight.png' },
