// Comprehensive worldwide country dial codes (230+ countries/territories)
export const COUNTRY_CODES = [
  ...
  { code: 'VG', name: 'Virgin Islands (British)', dial: '+1-284', flag: '🇻🇬' },
  { code: 'VI', name: 'Virgin Islands (US)', dial: '+1-340', flag: '🇻🇮' },
